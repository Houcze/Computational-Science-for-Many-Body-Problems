...
# Monte Calro simulation of the 3d Ising model
# 
# This code simulate 3d Ising model on the cubic lattice, whose Hamiltonian is given by
...
if algorithm == "cluster":
    ...
    pyplot.savefig('mag2: improved estimator 3d.jpg')
    pyplot.clf()
