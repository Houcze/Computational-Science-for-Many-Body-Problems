...
if algorithm == "cluster":
    ...
    pyplot.savefig('mag2: improved estimator.jpg')
    pyplot.clf()
...
# 
# You will see that when L is increased, the correlation times become longer in the vicinity of the critical temperature. In adittion, the corration-time difference between local updates and cluster update became much lager (longer) when L is increased.
