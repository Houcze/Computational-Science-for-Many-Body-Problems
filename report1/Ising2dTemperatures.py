...
def parse_args():
    ...
    parser.add_argument('-L',metavar='L',dest='L', type=int, default=128,
    ...
    parser.add_argument('-T', '--Temperature',metavar='T',dest='T', type=list,default=None,
    ...
    parser.add_argument('-c', '--correlation_time',metavar='correlation_time',dest='correlation_time', type=int,default=1000,
...
mag_1, mag2_1, mag2_imp_1, mag4_1, mag4_imp_1, mag_abs_1, ene_1, ene2_1 = MC(L,T1,h,thermalization,observation,random_seed,algorithm)
mag_2, mag2_2, mag2_imp_2, mag4_2, mag4_imp_2, mag_abs_2, ene_2, ene2_2 = MC(L,T2,h,thermalization,observation,random_seed,algorithm)
mag_3, mag2_3, mag2_imp_3, mag4_3, mag4_imp_3, mag_abs_3, ene_3, ene2_3 = MC(L,T3,h,thermalization,observation,random_seed,algorithm)
...
print ("Susceptibility = " + repr(M2_1/T1 * N) + " +- " +repr(M2_err/T1 * N))
...
print ("Susceptibility = " + repr(M2_2/T2 * N) + " +- " +repr(M2_err/T2 * N))
...
print ("Susceptibility = " + repr(M2_3/T3 * N) + " +- " +repr(M2_err/T3 * N))
print ("Binder ratio = " + repr(b_3) + " +- " +repr(b_err_3))

if algorithm == "cluster":
    print("=================== Temperature {} =========================".format(T1))
    ...
    print ("Susceptibility: improved estimator  = " + repr(M2_imp_1/T1 * N) + " +- " +repr(M2_imp_err_1/T1 * N))
    ...
    print ("Susceptibility: improved estimator  = " + repr(M2_imp_2/T1 * N) + " +- " +repr(M2_imp_err_2/T2 * N))
    ...
    print ("Susceptibility: improved estimator  = " + repr(M2_imp_3/T1 * N) + " +- " +repr(M2_imp_err_3/T3 * N))
...
pyplot.xlabel("$Time$")
pyplot.ylabel("$C_M2(t)$")
pyplot.plot(np.arange(cor_mag2_1.size),cor_mag2_1, label='{}'.format("$T<T_C$"), color='red')
pyplot.plot(np.arange(cor_mag2_2.size),cor_mag2_2, label='{}'.format(r"$T\approx{T_C}$"), color='blue')
pyplot.plot(np.arange(cor_mag2_3.size),cor_mag2_3, label='{}'.format("$T>T_C$"), color='yellow')
pyplot.legend()
pyplot.xlim([0,correlation_time])
# pyplot.xlim([0,100])
pyplot.subplots_adjust(left=0.2)
pyplot.savefig('C_M2(t)_T1T2T3.jpg')
pyplot.clf()
...
if algorithm == "cluster":
    ...
    pyplot.xlim([0,correlation_time])
    pyplot.savefig('C_M2_imp(t)_T1.jpg')
    pyplot.clf()
    ...
    pyplot.xlim([0,correlation_time])
    pyplot.savefig('C_M2_imp(t)_T2.jpg')
    pyplot.clf()
    ...
    pyplot.xlim([0,correlation_time])
    pyplot.savefig('C_M2_imp(t)_T3.jpg')
    pyplot.clf()
