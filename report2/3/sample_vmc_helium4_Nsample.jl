...
Nsample = 102400     # number of MC samples
...
savefig(@sprintf("sample_vmc_helium4_%d_Nsample.png", Nsample))

writedlm(@sprintf("vecr_%d_Nsample.txt", Nsample), vecr)
writedlm(@sprintf("gofr_%d_Nsample.txt", Nsample), gofr)
